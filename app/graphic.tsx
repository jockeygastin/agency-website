...
const Graphic = () => {
    return (  
         ...
         <div className="text-white" id='graphic'>
          <div className="p-4 mx-auto relative z-10 w-full pt-10 md:pt-20 px-2">
            <div className="text-4xl pb-5 md:text-7xl px-6 text-center bg-clip-text text-transparent bg-gradient-to-b from-purple-950 to bg-neutral-950 bg-opacity-50"> Website Design <br /> that Works
